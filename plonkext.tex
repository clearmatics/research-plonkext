...
%       \]
  ...
  Given updatable soundness and subversion zero-knowledge defined, we are ready
  to define updatable special simulation extractability
...
\begin{proof}
  ...
  the witness from a proof provided by some USSE adversary $\adv$ which produces
  an acceptable proof with probability $\accProb_\adv$.  The adversary $\bdv$
  proceeds as follows:
  \begin{itemize}
