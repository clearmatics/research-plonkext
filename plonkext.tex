...
\changedm{ We propose a new notion of \emph{updatable simulation extractability}
  ...
  it requires. For the ease of exposition we begin with definitions of
  \emph{updatable soundness} and \emph{updatable zero knowledge}
